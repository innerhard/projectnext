        ...
        <AppBar position="static" color="inherit" style={{ boxShadow: 'none', gridColumn: 2 }}>
            <Toolbar>
                ...
                <CustomIcon gradient={theme.linearGradient.cucumberWater}>
                    <svg width="40" height="30" viewBox="0 0 155 153" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <CustomIcon gradient={theme.linearGradient.cucumberWater}>
                    <svg width="40" height="30" viewBox="0 0 186 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <IconButton aria-label="cart">
                    <Styled.BadgeStyle badgeContent={state.count} color="secondary">
                        <ShoppingCartIcon />
                    </Styled.BadgeStyle>
                </IconButton>
            </Toolbar>
